...
public class SimulationTest {
    ...
    public void testRR() {
        ...
        assertThat(steps,contains(
           ...
           "T=0 Scheduled: T1 Ready: T2, T3, T4, T5", //T1 Done
                "T=1 Scheduled: T2 Ready: T3, T4, T5",
                "T=2 Scheduled: T2 Ready: T3, T4, T5", //T2 Done
                ...
                "T=12 Scheduled: T3 Ready: T4, T6, T7, T8, T9, T10, T5", //T3 Done
                "T=13 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5",
                "T=14 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5",
                "T=15 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5", //T4 Done
                ...
                "T=26 Scheduled: T9 Ready: T10, T5, T6, T7, T8", //T9 Done
                "T=27 Scheduled: T10 Ready: T5, T6, T7, T8", //T10 Done
                ...
                "T=36 Scheduled: T7 Ready: T8, T5, T6", //T7 Done
                "T=37 Scheduled: T8 Ready: T5, T6", //T8 Done
                "T=38 Scheduled: T5 Ready: T6",
                "T=39 Scheduled: T5 Ready: T6", //T5 Done
                "T=40 Scheduled: T6 Ready: ",
                "T=41 Scheduled: T6 Ready: ", //T6 Done
