    ...
    public void testRR() {
        ...
        assertThat(steps,contains(
           // Task 2: Write out expected view for 43 steps of Round Robin scheduling
		        "T=0 Scheduled: T1 Ready: T2, T3, T4, T5", //T1 ferdig

                "T=1 Scheduled: T2 Ready: T3, T4, T5",
                "T=2 Scheduled: T2 Ready: T3, T4, T5", //T2 ferdig
                ...
                "T=12 Scheduled: T3 Ready: T4, T6, T7, T8, T9, T10, T5", //T3 ferdig

                "T=13 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5",
                "T=14 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5",
                "T=15 Scheduled: T4 Ready: T6, T7, T8, T9, T10, T5", //T4 ferdig
                ...
                "T=26 Scheduled: T9 Ready: T10, T5, T6, T7, T8", //T9 ferdig

                "T=27 Scheduled: T10 Ready: T5, T6, T7, T8", //T10 ferdig
                ...
                "T=36 Scheduled: T7 Ready: T8, T5, T6", //T7 ferdig

                "T=37 Scheduled: T8 Ready: T5, T6", //T8 ferdig

                "T=38 Scheduled: T5 Ready: T6",
                "T=39 Scheduled: T5 Ready: T6", //T5 ferdig
