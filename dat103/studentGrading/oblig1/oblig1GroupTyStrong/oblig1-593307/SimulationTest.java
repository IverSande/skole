...
public class SimulationTest {
    ...
    public void testRR() {
        ...
        assertThat(steps, contains(
        	    ...
        	    "T=1 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=2 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=3 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=4 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=5 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=6 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=7 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=8 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=9 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=10 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=11 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=12 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=13 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=14 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=15 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=16 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=17 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=18 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=19 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=20 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=21 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=22 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=23 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=24 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=25 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=26 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=27 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=28 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=29 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=30 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=31 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=32 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=33 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=34 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=35 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=36 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=37 Scheduled: T3 Ready: T4, T5, T1, T2",
        	    "T=38 Scheduled: T4 Ready: T5, T1, T2, T3",
        	    "T=39 Scheduled: T5 Ready: T1, T2, T3, T4",
        	    "T=40 Scheduled: T1 Ready: T2, T3, T4, T5",
        	    "T=41 Scheduled: T2 Ready: T3, T4, T5, T1",
        	    "T=42 Scheduled: T3 Ready: T4, T5, T1, T2"
        	));
