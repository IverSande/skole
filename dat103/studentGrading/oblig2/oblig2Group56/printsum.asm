...
section .data
	meld 	db "Skriv to ensifrede tall skilt med mellomrom.", cr, lf
		db "Summen av tallene må være mindre enn 18 men over 10.", cr, lf
	meldlen equ $ - meld
	feilmeld db cr, lf, "Skriv kun sifre!", cr, lf
	feillen equ $ - feilmeld
	crlf db cr, lf
	crlflen equ $ - crlf
	sumfeil db cr, lf, "Summen av tallene kan ikke være mer enn 18 eller under 10", cr, lf
	sumfeillen equ $ - sumfeil
	entall db "1"
	entalllen equ $ - entall
...
_start:
    ...
    ;her sammenligner vi og ser om summen er mellom 10 og 18
    cmp ecx, 10
    jl Feil;
    cmp ecx, 18
    ja Feil
...
; Skriver ut sifferet lagret i ecx. Ingen sjekk på verdiområde.
    ...
    push ecx
    push edx
    add ecx, '&' ; Konverter tall til ascii.
    mov [siffer], ecx
