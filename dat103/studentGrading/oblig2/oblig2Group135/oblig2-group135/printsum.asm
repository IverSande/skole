...
; --------------------------------------------------------------------------------
skrivsiffer:
	; Skriver ut sifferet lagret ecx. Ingen sjekk på verdiområde
	push eax
	push ebx
	push ecx
	push edx
	...
	; printer ut sifferet på tier-plassen
	mov ecx,tier
	mov edx,1
	mov ebx, STDOUT
	mov eax, SYS_WRITE
	...
	; printer ut sifferet på ener-plassen
	mov ecx,siffer
	mov edx,1
	mov ebx, STDOUT
	mov eax, SYS_WRITE
...
Lokke:
	...
	cmp ecx,' '
	je Lokke
	cmp ecx,'0' ; Sjekk at tast er i området 0-9
	jb Feil
