...
section .data
	meld db "Skriv to ensifrede tall skilt med mellomrom.",cr,lf
	     db "Summen av tallene maa vaere storre enn 10 og mindre enn 18.",cr,lf
	meldlen equ $ - meld
	feilmeld db cr,lf, "Skriv kun sifre!",cr,lf
	feillen equ $ - feilmeld
; Task 2---------------------------
	feilmeld2 db cr,lf, "Tall er 10 eller mindre eller 18 eller storre.",cr,lf
	feillen2 equ $ - feilmeld2
; ---------------------------------	
	crlf db cr,lf
	crlflen equ $ - crlf
...
; Task 2
	cmp ecx,11 ; Sjekke at verdien vaar ligger mellom 10 og 17
	jb Feiltotal
	cmp ecx,17
	ja Feiltotal
...
lessiffer:
 ...
 Lokke:
	...
	cmp ecx,'9'
	ja Feil
	sub ecx,'0' ; Konverterer ascii til et tall.
