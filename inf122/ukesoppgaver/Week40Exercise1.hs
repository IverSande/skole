...
numberOfMoons system = numberOfMoonsHelper (planets system)

numberOfMoonsHelper :: [Planet] -> Integer
numberOfMoonsHelper [] = 0
numberOfMoonsHelper (a:as) = (toInteger $ length (moons a)) + numberOfMoonsHelper as

atLeastOneMoon :: PlanetarySystem -> [Planet]
atLeastOneMoon system = atLeastOneMoonHelper (planets system)

atLeastOneMoonHelper :: [Planet] -> [Planet]
atLeastOneMoonHelper [] = []
atLeastOneMoonHelper (a:as) = if length (moons a) > 0 then [a] ++ atLeastOneMoonHelper as else [] ++ atLeastOneMoonHelper as
